...
1. **[[Installation]]** — prebuilt binaries for Linux, macOS, Windows; Go install; build from source.
...
- **[[Tradeoffs and Non-Goals|Tradeoffs-and-Non-Goals]]** — what's on the roadmap, what's out of scope, known caveats.
