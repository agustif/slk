...
1. **[[Installation]]** — Homebrew `--HEAD`, Go `@main`, in-tree AUR PKGBUILD, build from source. This fork has **no GitHub Release yet**.
...
- **[[Gaps]]** — remaining OG holes, capture status, packaging (releases, AUR, tags).
