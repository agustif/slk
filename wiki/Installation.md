...
That auto-taps [agustif/homebrew-tap](https://github.com/agustif/homebrew-tap) and builds **v0.20.0** from source (or `main` with `--HEAD`).
...
In-tree `flake.nix` builds this source (`version = "0.20.0"`). Not a published nixpkgs package.
...
GitHub Release **v0.20.0** includes Windows zips from GoReleaser. Or clone and build:
