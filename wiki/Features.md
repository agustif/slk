...
- **Threads view** (`⚑ Threads` at top of sidebar): scrollable list of
  ...
  newest activity. Selecting a thread opens it in the side panel; the
  list re-ranks live as new replies arrive. Follow with `t` in the
  thread panel; unfollow removes the row.
